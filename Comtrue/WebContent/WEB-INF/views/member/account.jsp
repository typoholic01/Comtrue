...
<body>
	...
	<div class="row main col-sm-4 col-sm-offset-4">
		...
		<div class="main-login main-center">
			<form id="account" class="form-horizontal" method="post" action="./account">
				
				<!-- 사번 -->
				<div class="form-group">
					<label for="memberNo" class="cols-sm-2 control-label">사번</label>
					<div class="cols-sm-10">
						<div class="input-group">
							<span class="input-group-addon" style="    padding: 6px 13.5px;"><i class="fa fa-user fa" aria-hidden="true"></i></span>
							<input max="999" type="number" class="form-control" name="memberNo" id="memberNo" placeholder="사번을 입력해주세요" onblur="checkLength();" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="cols-sm-10">
						<div class="input-group">
							...
							<input type="text" class="form-control" name="rank" id="rank" placeholder="직급을 입력해주세요"/>
				...
				<div class="form-group">
					<button type="button" class="btn btn-primary btn-lg btn-block login-button" onclick="checkValues();">등록</button>
				</div>
			</form>
		</div>
	</div>
